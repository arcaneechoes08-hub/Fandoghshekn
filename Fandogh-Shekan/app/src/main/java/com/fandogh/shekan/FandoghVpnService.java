...
public class FandoghVpnService extends VpnService implements Runnable {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // راه‌اندازی سرویس پیش‌زمینه (Foreground) برای جلوگیری از کشته شدن توسط اندروید
    ...
    public void run() {
        try {
            ...
            // حل مشکل اندروید 10+: خواندن فایل از مسیر امن کتابخانه‌های اندروید
            String nativeDir = getApplicationInfo().nativeLibraryDir;
            File coreBin = new File(nativeDir, "libxray.so");
            if (!coreBin.exists()) {
                throw new Exception("هسته سیستمی یافت نشد! مطمئن شوید libxray.so در پوشه jniLibs قرار دارد.");
            }
            ...
            mInterface = builder.setSession("FandoghShekan")
                    ...
                    .addDisallowedApplication(getPackageName()) // مستثنی کردن خود اپلیکیشن
                    .establish();
    ...
    private void generateSingBoxConfig(String link, File dir, int tunFd) throws Exception {
        ...
        // ساخت ایمن JSON با استفاده از کلاس استاندارد اندروید
    ...
    private Notification buildNotification() {
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setSmallIcon(android.R.drawable.ic_secure) // آیکون پیش‌فرض اندروید
